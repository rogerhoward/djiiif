...
All seven are opt-in and backwards-compatible (no MAJOR bump). All open
...
4. [WEB-ANNOTATIONS](WEB-ANNOTATIONS.md) — serve W3C AnnotationPages
...
5. [CONTENT-SEARCH](CONTENT-SEARCH.md) — Content Search API 2.0 endpoint over a
